...
const AboutUsPage = () => {
  return (
    <div className=' overflow-x-hidden'>
      ...
      {/* main container */}
      <div className='about-main-container mt-[80px]'>
        <div className='flex w-full md:ml-[150px] max-md:ml-[40px] justify-center lg:ml-[230px] h-full items-center'>
          <div className='space-y-[17px] my-auto'>
            <h2 className='lg:text-[32px] md:text-[25px] py-[4px] text-secondary bg-primary w-fit px-10 Montserrat'>
              About
            </h2>
            <h3 className='text-[32px] text-white max-lg:text-2xl Marko'>
              Get 50% Off On
            </h3>
            <h1 className='lg:text-[70px] md:text-[50px] text-primary Marcellus'>
              Fahion Jewellery
            </h1>
            <p className='p-1 border border-primary w-fit'>
              <button className='border bg-primary Karla font-semibold text-secondary px-[25px] py-[1px] hover:bg-secondary hover:border border-primary hover:text-primary max-lg:text-sm duration-300' >
                Shop Now
              </button>
            </p>
          </div>
      ...
      <div className='mt-[50px] container'>
        ...
        {/* contain */}
        <div className='flex max-xl:flex-wrap max-xl:justify-center max-xl:gap-5 gap-10'>

          {/* image */}
          <div className='max-xl:flex max-xl:justify-center max-lg:mx-auto lg:w-[35%]'>
            <img src="/aboutusimg.svg" className='aboutimg1' />
          </div>

          <div className='space-y-5 xl:w-[65%] max-lg:mt-5'>
            <p className='text-[13.5px] max-lg:text-[14px] Karla'>
      ...
      <div className='mt-[50px] container'>
        ...
        <div className='flex max-xl:flex-wrap max-xl:justify-center max-xl:gap-5 gap-10'>
          ...
          <div className='space-y-5 xl:w-[60%]'>
            <p className='text-[13px] max-lg:text-[14px] Karla '>
          ...
          {/* image */}
          <div className='flex justify-center max-lg:mx-auto lg:w-[40%]'>
            <img src="ourvisionimg.svg" className='aboutimg2' />
          </div>
        </div>
      ...
      <div className='mt-[50px] container'>
        ...
        <div className='flex max-xl:flex-wrap max-xl:justify-center max-xl:gap-5 gap-10'>
          ...
          <div className='flex justify-center max-lg:mx-auto mb-5 xl:w-[40%]'>
            <img src="ourvaluesimg.svg" className='aboutimg3' />
          </div>
      ...
      <div className='mt-[50px] bg-[#BE9A807A] pb-[50px]'>
        <div className='container'>
          ...
          <div className='py-[50px]'>
            <h2 className='titlestyle w-full text-secondary font-semibold text-center Montserrat'>
              Why Regal Rediance ?
            </h2>
          </div>
            ...
            <div className="grid grid-cols-4 max-xl:grid-cols-2 gap-5">
              ...
              <div className='flex-wrap justify-center md:w-[250px]'>
                ...
                <div className="flex justify-center overflow-hidden bg-[#BE9A80] md:w-[250px]">
                  <img src="regalredianceimg1.svg" className='md:w-[250px] hover:scale-[1] scale-[0.8] duration-300 cursor-pointer' />
                </div>

                {/* text */}
                <div className='text-center mt-2 font-semibold md:text-[17px] Montserrat'>
              ...
              <div className='flex-wrap justify-center md:w-[250px]'>
                ...
                {/* image */}
                <div className="flex justify-center overflow-hidden bg-[#BE9A80] md:w-[250px]">
                  <img src="regalredianceimg2.svg" className='md:w-[250px] hover:scale-[1] scale-[0.8] duration-300 cursor-pointer' />
                </div>
              ...
              <div className='flex-wrap justify-center md:w-[250px]'>
                ...
                {/* image */}
                <div className="flex justify-center overflow-hidden bg-[#BE9A80] md:w-[250px]">
                  <img src="regalredianceimg3.svg" className='md:w-[250px] hover:scale-[1] scale-[0.8] duration-300 cursor-pointer' />
                </div>
              ...
              <div className='flex-wrap justify-center md:w-[250px]'>
                ...
                {/* image */}
                <div className="flex justify-center overflow-hidden bg-[#BE9A80] md:w-[250px]">
                  <img src="regalredianceimg4.svg" className='md:w-[250px] hover:scale-[1] scale-[0.8] duration-300 cursor-pointer' />
                </div>
