...
const AboutUsPage = () => {
  return (
    <div className=' overflow-x-hidden'>
      ...
      <div className='mt-[50px] container'>
        ...
        <div className='flex max-xl:flex-wrap max-xl:justify-center max-xl:gap-5 gap-10'>
          ...
          <div className='space-y-5 xl:w-[65%] max-lg:mt-5'>
            <p className='text-[13.5px] max-lg:text-[14px]'>
      ...
      <div className='mt-[50px] container'>
        ...
        <div className='flex max-xl:flex-wrap max-xl:justify-center max-xl:gap-5 gap-10'>
          ...
          <div className='space-y-5 xl:w-[60%]'>
            <p className='text-[13px] max-lg:text-[14px] '>
      ...
      <div className='mt-[50px] container'>
        {/* title */}
        <div className='titlestyle w-full mb-10 text-center'>
          <h2 className='titlestyle w-full'>
            Our Values
          </h2>
        </div>
      ...
      <div className='mt-[50px] bg-[#BE9A807A] pb-[50px]'>
        <div className='container'>
          ...
          <div className='py-[50px]'>
            <h2 className='titlestyle w-full text-secondary font-semibold text-center'>
              Why Regal Rediance ?
            </h2>
          </div>
          ...
          <div className='flex justify-center'>
            <div className="grid grid-cols-4 max-xl:grid-cols-2 gap-5">
              ...
              <div className='flex-wrap justify-center md:w-[250px]'>
                ...
                {/* text */}
                <div className='text-center mt-2 font-semibold md:text-[17px]'>
