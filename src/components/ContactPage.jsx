...
const ContactPage = () => {
  return (
    <div>
      ...
      {/* main container */}
      <div className='contact-main-container flex justify-center max-md:text-center items-center'>
        {/* contain */}
      ...
      <div className=' mt-[50px]'>
        ...
        {/* title */}
        <div className='text-center text-3xl font-semibold font-sans'>
          Contact us
        </div>
        ...
        <div className='container grid grid-cols-2 max-lg:grid-cols-1 mt-5 lg:space-x-10'>
            ...
            <div>
              <form className='flex flex-col space-y-5 mt-5'>
                ...
                <div className='max-md:flex max-md:justify-center p-1 border border-secondary w-fit'>
                  <button
                    className="bg-primary hover:bg-secondary hover:text-primary border hover:border-primary p-1 px-12 text-sm font-semibold duration-300"
                  >
                    Submit
                  </button>
                </div>
          ...
          <div className='max-lg:mt-5 space-y-2'>

            {/* address */}
            <div className='mt-[55px] space-y-1'>
              <h2 className='text-[23px] text-secondary max-md:text-center'>Address</h2>
              ...
              <p className='hover:text-secondary text-primary flex items-center align-middle w-fit space-x-1 duration-300 cursor-pointer contacthover'>
                ...
                <span className='text-[25px] duration-300 contactarrow'>
            ...
            <div className='space-y-1'>
              <h2 className='text-[23px] text-secondary max-md:text-center'>Contact</h2>
              <p className='text-[13px]'>
                +1 (212) 555-9847, <br />
                +1 (212) 555-7683
              </p>
            ...
            {/* Hours */}
            <div className='space-y-1'>
              <h2 className='text-[25px] text-secondary max-md:text-center'>Hours</h2>
              <p className='text-[13px]'>
                Monday - Saturday <br />
                10:00 AM To 07:00PM
              </p>
      ...
      <div className='container mt-[50px]'>
        ...
        <div className='grid grid-cols-2 max-lg:grid-cols-1  mt-5 max-lg:space-y-3'>
          ...
          {/* map */}
          <div className='lg:p-[25px] lg:lg:flex lg:justify-center'>
            <img src="jewellery-map.svg" alt="" className='w-full'/>
          </div>


          {/* contain/text */}
          <div className='lg:text-[15.5px] lg:p-4 max-lg:text-justify'>
